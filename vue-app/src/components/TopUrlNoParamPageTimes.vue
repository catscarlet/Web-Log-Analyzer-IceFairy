...
<div>
    ...
    <div class="panel-header">
        <span>TopUrlNoParamPageTimes List</span>
...
export default {
    ...
    methods: {
        initPage() {
            ...
            this.items = this.analyzed_data.top_urlnoparam_page_times_array;
        ...
        filterConfirmButton() {
            ...
            if (this.filter_input != '') {
                result = this.analyzed_data.top_urlnoparam_page_times_array.filter(this.excludeFilter);
            } else {
                result = this.analyzed_data.top_urlnoparam_page_times_array;
            }
