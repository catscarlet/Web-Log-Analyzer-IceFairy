...
<div>
    ...
    <div class="panel-header">
        <span>TopUrlNoParamPageTraffic List</span>
...
export default {
    ...
    methods: {
        initPage() {
            ...
            this.items = this.analyzed_data.top_urlnoparam_page_traffic_array,
        ...
        filterConfirmButton() {
            ...
            if (this.filter_input != '') {
                result = this.analyzed_data.top_urlnoparam_page_traffic_array.filter(this.excludeFilter);
            } else {
                result = this.analyzed_data.top_urlnoparam_page_traffic_array;
            }
